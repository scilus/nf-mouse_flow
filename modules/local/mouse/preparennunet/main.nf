process MOUSE_PREPARENNUNET {
    ...
    output:
        tuple val(meta), path("*_nnunetReady.nii.gz"), emit: out_operation
    ...
    N4BiasFieldCorrection  -d 3  -i ${INPUT}  -o ${OUTPUT_N4_FIRST}  -s 4 -b [80,3] -c [${CONVERGENCE_1},1e-6] -x ${MASK_OTSU_RESAMPLED_FIRST}  -v
